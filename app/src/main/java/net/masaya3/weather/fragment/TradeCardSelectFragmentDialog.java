...
public class TradeCardSelectFragmentDialog extends DialogFragment implements View.OnClickListener {
     ...
     * @return
     */
    public static TradeCardSelectFragmentDialog newInstance(long id){
        TradeCardSelectFragmentDialog dialog = new TradeCardSelectFragmentDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        dialog.setContentView(R.layout.tradecardselect_dialog);
    ...
    public View onCreateView(LayoutInflater i, ViewGroup c, Bundle b)
    {
        ...
        View content = i.inflate(R.layout.tradecardselect_dialog, null);


        content.findViewById(R.id.cancel_trade).setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if(onCardEventListener != null){
            switch (view.getId()){
                case R.id.cancel_trade:
                    onCardEventListener.onCancel(id);
                    break;
